...
<head>
    ...
    <script src="scripts/APIMATICCalculatorLib/Controllers/SimpleCalculatorGroupController.js"></script>
...
The singleton instance of the ``` SimpleCalculatorGroupController ``` class can be accessed via Dependency Injection.

```js
	app.controller("testController", function($scope, SimpleCalculatorGroupController){
	});
```
...
```javascript
	...
	app.controller("testController", function($scope, SimpleCalculatorGroupController){
        ...
        var x = 152.72135297196;
        var y = 152.72135297196;


		var result = SimpleCalculatorGroupController.calculate(operation, x, y);
