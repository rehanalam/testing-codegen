...
* [simplecalculatorgroup_pkg](#simplecalculatorgroup_pkg)

## <a name="simplecalculatorgroup_pkg"></a>![Class: ](https://apidocs.io/img/class.png ".simplecalculatorgroup_pkg") simplecalculatorgroup_pkg

### Get instance

Factory for the ``` SIMPLECALCULATORGROUP ``` interface can be accessed from the package simplecalculatorgroup_pkg.

```go
simpleCalculatorGroup := simplecalculatorgroup_pkg.NewSIMPLECALCULATORGROUP()
```

### <a name="calculate"></a>![Method: ](https://apidocs.io/img/method.png ".simplecalculatorgroup_pkg.Calculate") Calculate

> Calculates the expression using the specified operation.


```go
func (me *SIMPLECALCULATORGROUP_IMPL) Calculate(
            operation models_pkg.OperationTypeEnum,
            x float64,
...
var result *float64
result,_ = simpleCalculatorGroup.Calculate(operation, x, y)
