...
```javascript
var controller = lib.SimpleCalculatorGroupController;
```
...
```javascript
function calculate(operation, x, y, callback)
```
#### Parameters
...
```javascript
    ...
    var x = 130.484025420381;
    var y = 130.484025420381;

    controller.calculate(operation, x, y, function(error, response, context) {
